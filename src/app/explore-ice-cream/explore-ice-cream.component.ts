...
@Component({
  selector: 'app-explore-ice-cream',
  templateUrl: './explore-ice-cream.component.html',
  styleUrls: ['./explore-ice-cream.component.css']
})
export class ExploreIceCreamComponent implements OnInit {
  iceCreamFlavours: IceCream[] = [];

  ngOnInit(): void {
    this.iceCreamFlavours = [
      {
        "id": 1,
      ...
      },
      {
        ...
        "imagepath": "fruitae-strawbery.png"
      },
      {
        "id": 4,
